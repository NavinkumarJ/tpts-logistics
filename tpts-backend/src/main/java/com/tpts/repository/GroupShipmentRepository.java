...
public interface GroupShipmentRepository extends JpaRepository<GroupShipment, Long> {
    ...
    List<GroupShipment> findByCompanyIdAndStatusIn(@Param("companyId") Long companyId, @Param("statuses") List<GroupStatus> statuses);
    ...
    void updateStatus(@Param("groupId") Long groupId, @Param("status") GroupStatus status, @Param("now") LocalDateTime now);
