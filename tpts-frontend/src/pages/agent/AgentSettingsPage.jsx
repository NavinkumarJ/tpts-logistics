    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="relative">
                        {agent?.profilePhotoUrl ? (
                            ...
                            <div className="w-28 h-28 rounded-full bg-white/20 flex items-center justify-center border-4 border-white/30 shadow-lg">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <h1 className="text-2xl font-bold">{agent?.fullName || "Agent"}</h1>
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-3">
                            ...
                            <span className="flex items-center gap-1 text-sm text-white/90">
                                ...
                                <span className="text-white/60">({agent?.totalRatings || 0} reviews)</span>
                            </span>
                            <span className="flex items-center gap-1 text-sm text-white/90">
                                <FaShippingFast /> {agent?.totalDeliveries || 0} deliveries
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 md:gap-6">
                        <div className="text-center">
                            <div className="text-3xl font-bold">{agent?.currentOrdersCount || 0}</div>
                            <div className="text-xs text-white/70 uppercase tracking-wide">Active</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold">{agent?.totalDeliveries || 0}</div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-gray-900 text-lg">Availability Status</h3>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                        <FaCog className="text-orange-500" /> Account Information
                    </h3>
                </div>
                <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-900 break-all">{agent?.email || "N/A"}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-900">{agent?.companyName || "N/A"}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            <div
                                className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${agent?.isActive ? "bg-green-50 text-green-500" : "bg-red-50 text-red-500"
                                    }`}
                            >
                            ...
                            <div>
                                ...
                                <p className={`font-medium ${agent?.isActive ? "text-green-600" : "text-red-600"}`}>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-900">{agent?.licenseNumber || "N/A"}</p>
                            </div>
                        </div>

                        {/* Vehicle Number */}
                        <div className="flex items-start gap-3">
                            <div className="w-10 h-10 rounded-lg bg-teal-50 flex items-center justify-center text-teal-500 flex-shrink-0">
                                {getVehicleIcon(agent?.vehicleType)}
                            </div>
                            <div>
                                <p className="text-xs text-gray-500 uppercase tracking-wide">Vehicle Number</p>
                                <p className="font-medium text-gray-900">{agent?.vehicleNumber || "N/A"}</p>
                            </div>
                        </div>
                ...
                <div className="p-6">
                    <form onSubmit={handlePasswordChange} className="space-y-4">
                        ...
                        <button
                            ...
                            className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-md hover:shadow-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {changingPassword ? (
                                <>
            ...
            <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                        <FaBell className="text-orange-500" /> Notification Preferences
                    </h3>
                </div>
                <div className="p-6">
                    <div className="space-y-4">
                        {[
                            ...
                            <div
                                key={pref.id}
                                className="flex items-center justify-between py-4 px-4 rounded-xl hover:bg-gray-50 transition"
                            >
                                <div className="flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className={`relative w-14 h-8 rounded-full transition-colors ${notificationPrefs[pref.id] ? "bg-orange-500" : "bg-gray-300"
                                        }`}
                                >
                                    <div
